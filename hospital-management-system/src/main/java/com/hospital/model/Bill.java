...
public class Bill {
    ...
    public Bill(int billId, Patient patient, BigDecimal consultationCharge,
                BigDecimal medicineCharge, BigDecimal otherCharge,
                BigDecimal totalAmount, String billDate, BillStatus status) {
        this.billId = billId;
        ...
        public Bill(int billId, Appointment appointment, BigDecimal consultationCharge,
            BigDecimal medicineCharge, BigDecimal otherCharge,
            BigDecimal totalAmount, String billDate, BillStatus status) {
        this(billId, appointment == null ? null : appointment.getPatient(), consultationCharge,
            medicineCharge, otherCharge, totalAmount, billDate, status);
        setAppointment(appointment);
        }

        public Bill(int billId, Patient patient, BigDecimal consultationCharge,
            BigDecimal medicineCharge, BigDecimal otherCharge,
            BigDecimal totalAmount, String billDate, String status) {
        this(billId, patient, consultationCharge, medicineCharge, otherCharge,
    ...
    public void setStatus(String status) { this.status = BillStatus.valueOf(status.toUpperCase()); }
